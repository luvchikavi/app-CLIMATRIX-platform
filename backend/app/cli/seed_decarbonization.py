...
INITIATIVES = [
    # --- ENERGY EFFICIENCY ---
    {
        ...
        "typical_reduction_percent_min": 5,
        "typical_reduction_percent_max": 12,
        "typical_reduction_percent_median": 8,
        "typical_capex_per_tco2e_reduced": 150,
        "typical_opex_change_percent": -15,
        "typical_payback_years_min": 1.5,
        "typical_payback_years_max": 3,
        "complexity": "low",
        "implementation_time_months_min": 2,
    ...
    },
    {
        ...
        "typical_reduction_percent_min": 10,
        "typical_reduction_percent_max": 25,
        "typical_reduction_percent_median": 18,
        "typical_capex_per_tco2e_reduced": 200,
        "typical_opex_change_percent": -20,
        "typical_payback_years_min": 2,
        "typical_payback_years_max": 4,
        "complexity": "medium",
    ...
    },
    {
        ...
        "typical_reduction_percent_min": 8,
        "typical_reduction_percent_max": 20,
        "typical_reduction_percent_median": 14,
        "typical_capex_per_tco2e_reduced": 300,
        "typical_opex_change_percent": -25,
        "typical_payback_years_min": 2,
        "typical_payback_years_max": 5,
        "complexity": "medium",
        "implementation_time_months_min": 3,
    ...
    },
    {
        ...
        "typical_reduction_percent_min": 5,
        "typical_reduction_percent_max": 15,
        "typical_reduction_percent_median": 10,
        "typical_capex_per_tco2e_reduced": 500,
        "typical_opex_change_percent": -10,
        "typical_payback_years_min": 5,
        ...
        "common_barriers": [
            "High upfront cost",
            "Not applicable to leased spaces",
    ...
    # --- RENEWABLE ENERGY ---
    {
        ...
        "typical_reduction_percent_min": 15,
        "typical_reduction_percent_max": 40,
        "typical_reduction_percent_median": 25,
        "typical_capex_per_tco2e_reduced": 400,
        "typical_opex_change_percent": -30,
        "typical_payback_years_min": 4,
        "typical_payback_years_max": 8,
        "complexity": "medium",
        "implementation_time_months_min": 4,
        "implementation_time_months_max": 12,
        "co_benefits": [
            "Energy price hedging",
            "Corporate sustainability branding",
            "Potential revenue from feed-in tariffs",
        ],
        "common_barriers": [
    ...
    },
    {
        ...
        "typical_reduction_percent_min": 80,
        "typical_reduction_percent_max": 100,
        "typical_reduction_percent_median": 95,
        "typical_capex_per_tco2e_reduced": 20,
        "typical_opex_change_percent": 5,
        "typical_payback_years_min": 0,
        "typical_payback_years_max": 1,
        "complexity": "low",
        "implementation_time_months_min": 1,
        "implementation_time_months_max": 6,
        "co_benefits": [
            "100% Scope 2 reduction possible",
            "SBTi-aligned",
            "Market-based reporting advantage",
        ],
        "common_barriers": [
            "5-10% premium on electricity cost",
            "PPA contract length (10-15 years)",
    ...
    # --- FLEET & TRANSPORT ---
    {
        ...
        "typical_reduction_percent_min": 60,
        "typical_reduction_percent_max": 95,
        "typical_reduction_percent_median": 80,
        "typical_capex_per_tco2e_reduced": 600,
        "typical_opex_change_percent": -40,
        "typical_payback_years_min": 3,
        "typical_payback_years_max": 6,
        "complexity": "medium",
        "implementation_time_months_min": 6,
    ...
    },
    {
        ...
        "typical_reduction_percent_min": 8,
        "typical_reduction_percent_max": 18,
        "typical_reduction_percent_median": 12,
        "typical_capex_per_tco2e_reduced": 30,
        "typical_opex_change_percent": -12,
        "typical_payback_years_min": 0.5,
        "typical_payback_years_max": 1.5,
        "complexity": "low",
        "implementation_time_months_min": 1,
    ...
    # --- BUSINESS TRAVEL ---
    {
        ...
        "typical_reduction_percent_min": 25,
        "typical_reduction_percent_max": 50,
        "typical_reduction_percent_median": 35,
        "typical_capex_per_tco2e_reduced": 10,
        "typical_opex_change_percent": -50,
        "typical_payback_years_min": 0,
        "typical_payback_years_max": 0.5,
        "complexity": "low",
        "implementation_time_months_min": 1,
        "implementation_time_months_max": 3,
        "co_benefits": [
        ...
        "common_barriers": [
            "Cultural resistance",
            "Client expectations for in-person meetings",
            "Sales team pushback",
        ],
    },
    {
        ...
        "typical_reduction_percent_min": 60,
        "typical_reduction_percent_max": 90,
        "typical_reduction_percent_median": 75,
        "typical_capex_per_tco2e_reduced": 0,
        "typical_opex_change_percent": -10,
        "typical_payback_years_min": 0,
        "typical_payback_years_max": 0,
        "complexity": "low",
        "implementation_time_months_min": 1,
        ...
        "common_barriers": [
            ...
            "Longer travel times for some routes",
        ],
    },
    # --- EMPLOYEE COMMUTING ---
    {
        ...
        "typical_reduction_percent_max": 50,
        "typical_reduction_percent_median": 40,
        "typical_capex_per_tco2e_reduced": 5,
        "typical_opex_change_percent": -20,
        "typical_payback_years_min": 0,
        "typical_payback_years_max": 0.5,
        "complexity": "low",
    ...
    },
    {
        ...
        "typical_reduction_percent_min": 15,
        "typical_reduction_percent_max": 30,
        "typical_reduction_percent_median": 22,
        "typical_capex_per_tco2e_reduced": 80,
        "typical_opex_change_percent": 10,
        "typical_payback_years_min": 2,
        "typical_payback_years_max": 5,
        "complexity": "medium",
        ...
        "common_barriers": [
            "Route coverage limitations",
            "Ongoing operational cost",
            "Low adoption in car-centric regions",
        ],
    },
    # --- WASTE ---
    {
        ...
        "applicable_activity_keys": [
            ...
            "waste_recycled_paper",
            "waste_recycled_plastic",
        ],
        "typical_reduction_percent_min": 50,
        "typical_reduction_percent_max": 90,
        "typical_reduction_percent_median": 70,
        "typical_capex_per_tco2e_reduced": 50,
        "typical_opex_change_percent": -5,
        "typical_payback_years_min": 1,
        "typical_payback_years_max": 3,
        "complexity": "medium",
        "implementation_time_months_min": 3,
        "implementation_time_months_max": 12,
    ...
    },
    {
        ...
        "implementation_time_months_max": 6,
        "co_benefits": [
            "Cost savings from fewer purchases",
            "Reduced e-waste",
            "Lower embodied carbon",
        ],
        "common_barriers": [
            "Performance complaints from users",
            "Warranty expiration risks",
    ...
    # --- SUPPLY CHAIN ---
    {
        ...
        "typical_reduction_percent_min": 10,
        "typical_reduction_percent_max": 25,
        "typical_reduction_percent_median": 15,
        "typical_capex_per_tco2e_reduced": 0,
        "typical_opex_change_percent": 0,
        "typical_payback_years_min": 0,
        "typical_payback_years_max": 0,
        "complexity": "low",
        "implementation_time_months_min": 2,
        ...
        "co_benefits": [
            ...
            "Vendor engagement on sustainability",
            "ESG reporting alignment",
        ],
        "common_barriers": [
            "Limited product availability",
            "Higher unit cost for certified products",
        ],
    },
    {
        "category": "supply_chain",
        ...
        "typical_reduction_percent_min": 30,
        "typical_reduction_percent_max": 70,
        "typical_reduction_percent_median": 50,
        "typical_capex_per_tco2e_reduced": 100,
        "typical_opex_change_percent": -10,
        "typical_payback_years_min": 1,
        "typical_payback_years_max": 3,
        "complexity": "high",
    ...
    },
    {
        ...
        "typical_reduction_percent_min": 30,
        "typical_reduction_percent_max": 60,
        "typical_reduction_percent_median": 40,
        "typical_capex_per_tco2e_reduced": 0,
        "typical_opex_change_percent": -15,
        "typical_payback_years_min": 0,
        ...
        "co_benefits": [
            "Cost savings",
            "Healthier employee diet",
            "Water footprint reduction",
        ],
        "common_barriers": [
            "Employee preferences",
            "Cultural sensitivity",
            "Caterer capabilities",
        ],
    },
    # --- REFRIGERANTS ---
    {
        ...
        "typical_reduction_percent_median": 65,
        "typical_capex_per_tco2e_reduced": 100,
        "typical_opex_change_percent": 0,
        "typical_payback_years_min": 3,
        "typical_payback_years_max": 7,
        "complexity": "medium",
        "implementation_time_months_min": 6,
        "implementation_time_months_max": 24,
        "co_benefits": [
        ...
        "common_barriers": [
            ...
            "Technician certification needed",
            "Phased rollout during maintenance cycles",
        ],
    },
    # --- GENERATORS ---
    {
        ...
        "typical_reduction_percent_min": 60,
        "typical_reduction_percent_max": 100,
        "typical_reduction_percent_median": 85,
        ...
        "co_benefits": [
            ...
            "Grid balancing revenue potential",
            "Faster power switchover",
        ],
        "common_barriers": [
            "High upfront cost",
            "Space requirements",
    ...
    # --- CARBON REMOVAL ---
    {
        ...
        "typical_reduction_percent_min": 100,
        "typical_reduction_percent_max": 100,
        "typical_reduction_percent_median": 100,
        "typical_capex_per_tco2e_reduced": 25,
        "typical_opex_change_percent": 0,
        "typical_payback_years_min": 0,
        "typical_payback_years_max": 0,
        "complexity": "low",
        ...
        "implementation_time_months_max": 3,
        "co_benefits": [
            "Immediate carbon neutrality claim",
            "Community development co-benefits",
            "Biodiversity support",
        ],
        "common_barriers": [
            "Not counted as reduction in SBTi",
            "Greenwashing perception risk",
    ...
    for data in INITIATIVES:
        initiative = Initiative(
            ...
            typical_reduction_percent_min=Decimal(
                str(data["typical_reduction_percent_min"])
            ),
            typical_reduction_percent_max=Decimal(
                str(data["typical_reduction_percent_max"])
            ),
            typical_reduction_percent_median=Decimal(
                str(data["typical_reduction_percent_median"])
            ),
            typical_capex_per_tco2e_reduced=(
                Decimal(str(data.get("typical_capex_per_tco2e_reduced", 0)))
                if data.get("typical_capex_per_tco2e_reduced")
                else None
            ),
            typical_opex_change_percent=(
                Decimal(str(data.get("typical_opex_change_percent", 0)))
                if data.get("typical_opex_change_percent") is not None
                else None
            ),
            typical_payback_years_min=(
                Decimal(str(data.get("typical_payback_years_min", 0)))
                if data.get("typical_payback_years_min") is not None
                else None
            ),
            typical_payback_years_max=(
                Decimal(str(data.get("typical_payback_years_max", 0)))
                if data.get("typical_payback_years_max") is not None
                else None
            ),
...
async def seed_nice_decarb(session: AsyncSession, force: bool = False):
    ...
    result = await session.execute(
        select(DecarbonizationTarget).where(
            DecarbonizationTarget.organization_id == org.id
        )
    )
    existing = result.scalar_one_or_none()
    if existing and not force:
        typer.echo(
            "NICE decarbonization plan already exists. Use --force to re-create."
        )
        return
        ...
        for scenario in scenarios_result.scalars().all():
            await session.execute(
                delete(RoadmapMilestone).where(
                    RoadmapMilestone.scenario_id == scenario.id
                )
            )
            await session.execute(
                delete(ScenarioInitiative).where(
                    ScenarioInitiative.scenario_id == scenario.id
                )
            )
        await session.execute(
            delete(Scenario).where(Scenario.organization_id == org.id)
        )
        from app.models.decarbonization import EmissionCheckpoint

        await session.execute(
            delete(EmissionCheckpoint).where(
                EmissionCheckpoint.organization_id == org.id
            )
        )
        await session.execute(
    ...
    {s.name: s for s in sites_result.scalars().all()}
    ...
    for ni in nice_initiatives:
        ...
        if not initiative:
            typer.echo(
                f"  WARN: Initiative '{ni['initiative_name']}' not found in library"
            )
            continue
    ...
    scenario.target_achievement_percent = min(
        Decimal("100"),
        (
            (total_reduction / required_reduction * 100)
    ...
    typer.echo(f"\n{'='*60}")
    typer.echo("NICE Decarbonization Plan Seeded")
    typer.echo(f"{'='*60}")
    typer.echo(
        f"Target:        40% reduction by 2030 ({float(total_tco2e):,.0f} → {float(target_emissions):,.0f} tCO2e)"
    )
    typer.echo("Scenario:      Accelerated Decarbonization Plan")
    typer.echo(f"Initiatives:   {len(nice_initiatives)}")
    typer.echo(
        f"Total Reduction: {float(total_reduction):,.0f} tCO2e ({float(scenario.target_achievement_percent):.0f}% of target)"
    )
...
@cli.command()
def main(
    with_nice_demo: bool = typer.Option(
        False, "--with-nice-demo", help="Also seed NICE demo decarbonization plan"
    ),
