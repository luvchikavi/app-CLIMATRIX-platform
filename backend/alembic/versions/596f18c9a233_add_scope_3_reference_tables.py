...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "transport_mode", sa.String(50), nullable=False, default="sea_container"
        ),
    ...
    op.create_index(
        "ix_transport_distance_matrix_origin_country",
        "transport_distance_matrix",
        ["origin_country"],
    )
    op.create_index(
        "ix_transport_distance_matrix_destination_country",
        "transport_distance_matrix",
        ["destination_country"],
    )
    ...
    op.create_index(
        "ix_currency_conversions_from_currency",
        "currency_conversions",
        ["from_currency"],
    )
    op.create_index(
        "ix_currency_conversions_valid_from", "currency_conversions", ["valid_from"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "typical_price_usd", sa.Numeric(precision=12, scale=2), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "electricity_kwh_per_night",
            sa.Numeric(precision=10, scale=4),
            nullable=True,
        ),
        sa.Column(
            "heating_kwh_per_night", sa.Numeric(precision=10, scale=4), nullable=True
        ),
        sa.Column(
            "water_liters_per_night", sa.Numeric(precision=10, scale=4), nullable=True
        ),
        sa.Column("source", sa.String(100), nullable=False),
    ...
    op.create_index(
        "ix_hotel_emission_factors_country_code",
        "hotel_emission_factors",
        ["country_code"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "td_loss_percentage", sa.Numeric(precision=5, scale=2), nullable=True
        ),
        sa.Column("source", sa.String(100), nullable=False),
        sa.Column("year", sa.Integer, nullable=False),
        sa.Column("is_active", sa.Boolean, nullable=False, default=True),
    ...
    op.create_index(
        "ix_grid_emission_factors_country_code",
        "grid_emission_factors",
        ["country_code"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "avoided_co2e_per_kg", sa.Numeric(precision=10, scale=6), nullable=True
        ),
    ...
    op.create_index(
        "ix_waste_disposal_factors_waste_type", "waste_disposal_factors", ["waste_type"]
    )
    op.create_index(
        "ix_waste_disposal_factors_disposal_method",
        "waste_disposal_factors",
        ["disposal_method"],
    )
