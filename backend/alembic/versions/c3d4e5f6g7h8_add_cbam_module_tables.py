...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "annual_production_capacity_tonnes", sa.Numeric(18, 2), nullable=True
        ),
        ...
        sa.Column(
            "electricity_consumption_mwh_per_tonne", sa.Numeric(18, 6), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            "reporting_year",
            "reporting_quarter",
            name="uq_cbam_quarterly_org_year_quarter",
        ),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "organization_id", "reporting_year", name="uq_cbam_annual_org_year"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column(
            "country_code", sa.String(2), nullable=False, unique=True, index=True
        ),
