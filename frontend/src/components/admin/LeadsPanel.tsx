...
/**
 * The lead CRM: filterable list with inline status moves, click-to-edit
 * notes and the one-click follow-up email. Used by the super-admin cockpit
 * (Leads tab) and the standalone /leads page.
 */
