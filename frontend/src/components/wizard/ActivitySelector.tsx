...
import { cn, formatFactor} from '@/lib/utils';
                      ...
                      >
                        <div className="flex-1 min-w-0">
                          ...
                          <span className="text-xs text-foreground-muted">
                            ...
                            {factor.co2e_factor && ` • ${formatFactor(factor.co2e_factor)} kg CO2e`}
                          </span>
                        </div>
              ...
              <div className="mt-1 flex flex-wrap gap-2">
                ...
                {selectedFactor.co2e_factor && (
                  <span className="text-xs bg-primary/10 text-primary px-2 py-1 rounded">
                    EF: {formatFactor(selectedFactor.co2e_factor)} kg CO2e/{selectedFactor.unit || selectedFactor.activity_unit}
                  </span>
                )}
