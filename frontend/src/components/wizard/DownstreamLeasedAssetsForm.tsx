  ...
  const preview = useMemo(() => {
    ...
    if (method === 'average') {
      if (assetCategory === 'building') {
        ...
        return {
          ...
          unit: 'm2',
          co2e,
          formula: `${formatQty(area)} m2 x ${formatFactor(ef)} kg CO2e/m2 = ${co2e.toFixed(2)} kg CO2e`,
          efSource: 'DEFRA 2024',
        };
      } else {
        ...
        return {
          ...
          unit: 'unit',
          co2e,
          formula: `${formatQty(units)} units x ${formatFactor(ef)} kg CO2e/unit = ${formatQty(co2e)} kg CO2e`,
          efSource: 'DEFRA 2024',
        };
      }
    }
    ...
    if (method === 'asset-specific') {
      ...
      return {
        ...
        unit: 'kWh',
        co2e,
        formula: `${formatQty(energy)} kWh x ${formatFactor(ef)} kg CO2e/kWh = ${co2e.toFixed(2)} kg CO2e`,
